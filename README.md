...
# 💫 About Me:
I'm **Kong Sothearith**, a Software Engineering Major at a private institution called Cambodia Academy of Digital Technology (CADT).<br> I'm studying with a role in mind, And it is to become an innovator as a full-stack developer.<br>I enjoy developing web pages that solve real-life problems.<br>I hope to build a start-up one day.
...
![](https://github-readme-stats.vercel.app/api/top-langs/?username=K-Sothearith&theme=dark&hide_border=false&include_all_commits=false&count_private=false&layout=compact)

---
[![](https://visitcount.itsvg.in/api?id=K-Sothearith&icon=0&color=0)](https://visitcount.itsvg.in)

<!-- Proudly created with GPRM ( https://gprm.itsvg.in ) -->

<!--
**K-Sothearith/K-Sothearith** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
